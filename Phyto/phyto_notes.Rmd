...
```
it just seems to get hung up without any output.  Had some dependency issues so installed the required packages.  New error message is "subscript out of bounds".  It looks like it opens the connection and then this happens... was missing clean_string and clean_up
