...
Directory structure is important for maintainability/ scalability of code.  The three main components of a Shiny app are global, ui and server (making up initial directoryforking) 