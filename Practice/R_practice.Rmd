...
```
this sis close to a working version but the random id(iva ave func snippet) is being assigned to values with cumulative above 1.  Don't want that.
```{r}
library(dplyr)
...
demands.df <- data.table::fread("https://icprbcoop.org/drupal4/products/coop_pot_withdrawals.csv",
                            data.table = FALSE)


demands.long <- gather(demands.df,Site, Flow, 2:6)
