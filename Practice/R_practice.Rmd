...
#remove useless entries in maps dataframe
map.df <- tail(map.df, -10)
map.df <- head(map.df,-4)
...
#a test of our pattern
test_out <- str_match(test_url, pattern_date)#out[25] , pattern_time)
print(test_out)

###this is what you want to do but it's not working as is(llok at it tomorow)
map2.df <- extract(map.df,html, c("html","date"), regex = pattern_date, remove =FALSE)


map2.df <- separate(map.df,html, c("html","date"), sep =  pattern_date)

print(head(map2.df$trash))
```
