...
# get add_row to work correctly
 ...
 #read temp file(grabbing the data that has added dummy rows and is still in wide format)
withdrawals_raw.df <- data.table::fread(paste0(ts_path, "download_data_w_actual.csv"),
                                  data.table = FALSE)
...
write.csv(withdrawals_formatted.df, paste0(ts_path, "download_data_w_format_test.csv"), row.names=FALSE)
```
