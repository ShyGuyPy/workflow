...
-change presentatioon of squares to better mirror sate warning standards(for Md and Va)
...
-tighten layout (adjust heighs)(icon size block further height adjustment)
-remove "Flow at Point of Rocks Panel"
x-move quadrant of graphs up(Cherie did this)
-inscrease readabbility of large graph, simply small graphs
x-tweak css until it pops(sorta did this)
