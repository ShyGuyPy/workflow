...
html/css feature integration, various reactive render types, andShiny in general(I was just an intern and work in Python(not R or Shiny) just a few weeks ago after all.  Going to need a little practice/tutorials from time to time)
