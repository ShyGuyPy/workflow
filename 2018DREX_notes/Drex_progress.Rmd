...
-could the VA labels be bigger?
-could we have MD labels too? - either above or below the map (Western and Central)
-add title_stage varaible in place of infor box titles that can change based on your bools
-MD color key(small)...add grey for no value
-Virginia color key P GW SW R
-slightly expand inforbox right box (maybe 10%)
