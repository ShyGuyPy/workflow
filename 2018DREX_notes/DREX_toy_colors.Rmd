...
ui <- dashboardPage(
  dashboardHeader(title = "warning"),
  dashboardSidebar(),
  dashboardBody(          shinydashboard::valueBoxOutput("precip_value"#, 
          #height = "200px"
          ))
)

# ui <- dashboardPage(titlePanel("make a box"),
#           #       box(
#           # title = "warning",
#           # width = NULL,
#           shinydashboard::valueBoxOutput("precip_value", 
#           height = "200px")
#           )
#)
...
server <- function(input,output){
  ...
  output$precip_value <- renderValueBox({
